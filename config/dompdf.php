    ...
    */
    ...
    'options' => [
        ...
        'font_family' => [
            ...
            'calibri' => [
                'normal' => storage_path('fonts/calibri-regular.ttf'),
                'bold' => storage_path('fonts/calibri-bold.ttf'),
                'italic' => storage_path('fonts/calibri-italic.ttf'),
                'bold_italic' => storage_path('fonts/calibri-bold-italic.ttf'),
            ],
            'tahoma' => [
                'normal' => storage_path('fonts/tahoma.ttf'),
                'bold' => storage_path('fonts/tahoma-bold.ttf'),
                'italic' => storage_path('fonts/tahoma.ttf'), // jika tidak punya versi italic
                'bold_italic' => storage_path('fonts/tahoma-bold.ttf'),
            ],
        ],
