...
export default function SalesChart() {
    ...
    const [sales, setPurchases] = useState([])
    ...
    useEffect(() => {
        async function fetchData() {
            const { data } = await axios.get("/admin/sale/chart", {
                params: {
            ...
            const total = _purchases.reduce((acc: number, item: any) => acc + parseFloat(item.sales), 0)
            const avg = total / _purchases.length
            const max = Math.max(..._purchases.map((item: any) => item.sales))
        ...
        <Card>
            <CardHeader className="pb-4">
                <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                    <div>
                        ...
                        <CardDescription>Analisis penjualan berdasarkan rentang waktu</CardDescription>
                    </div>
            ...
            <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                    ...
                    <Card className="mb-6">
                        <CardHeader className="pb-2">
                            <CardDescription>Penjualan Tertinggi</CardDescription>
                    ...
                    >
                        <ResponsiveContainer width="100%" height="100%">
                            <BarChart data={sales} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
                                ...
                                />
                                <Bar dataKey="sales" fill="green" radius={[4, 4, 0, 0]} />
                            </BarChart>
                        </ResponsiveContainer>
                    </ChartContainer>
                </div>
