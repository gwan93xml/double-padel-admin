...
<body>
    ...
    <h3>BUKTI PENERIMAAN PIUTANG</h3>
    <table>
        <tr>
    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>Penerimaan piutang {{$cashIn->accountReceivableHeader->number}}</td>
                <td>IDR</td>
                <td></td>
                <td class="text-right">{{rupiah($cashIn->accountReceivableHeader->total)}}</td>
            </tr>
            <tr class="total">
