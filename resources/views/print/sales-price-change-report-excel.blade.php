    ...
    <thead>
        <tr>
            <td colspan="{{ 4 + (count($reports[0]['months']) * 3) }}" style="text-align: center; font-weight: bold; font-size: 16px;">
                LAPORAN PERUBAHAN HARGA PENJUALAN
            </td>
        </tr>
    </thead>
</table>
<table>
    ...
    <tbody>
        ...
        <tr style="background-color: #f0f0f0; font-weight: bold;">
            ...
            <!-- Total keseluruhan omset customer semua bulan -->
            <td style="background-color: #d0d0d0;"><strong>{{ rupiah($report['omset']) }}</strong></td>
        </tr>
        
        <!-- Empty row for spacing between customers -->
        <tr>
